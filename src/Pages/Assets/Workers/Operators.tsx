...
export default function OperatorsPage(props: any) {
    ...
    const columns = [
        { title: 'Operador', dataIndex: 'name', sorter: true, key: 'name', width: 200,
    ...
    const formFields = [
        ...
        {
            cols: [
                { field: 'social_denomination', span: 18 },
                { field: 'nif', span: 6}
            ]
        },
        {
    ...
    const onMapDataToExport = (data: Array<any>) => {
        return data.map((worker: any) => {
            return {
                ...
                'Antecedência': worker.data.antecedence,
    ...
    return (
        <div className="content_page">
            {props.action == 'list' &&
                <>
                    <List type="operators" label={label} columns={columns} onMapDataToExport={onMapDataToExport} onOpenDetails={onOpenDetails} />
                    ...
                    <Drawer
                        ...
                        {details && <>
                            <Row>
                                ...
                                <Col span={12} style={{ marginBottom: 15 }}>
                                    <Space direction="vertical">
                                        <Text strong>Tabela Operador</Text>
                                ...
                                <Col span={12} style={{ marginBottom: 15 }}>
                                    <Space direction="vertical">
                                        <Text strong>Antecedência</Text>
                                        <Text>{details.antecedence}</Text>
                                    </Space>
                                </Col>
            ...
            {(props.action && ['create', 'edit'].includes(props.action)) &&
                <Form type="operators" label={label} action={props.action} formFields={formFields} />
            }
        </div>
    )
}
